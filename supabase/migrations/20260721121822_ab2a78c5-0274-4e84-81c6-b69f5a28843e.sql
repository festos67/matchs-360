-- Restore and version public template data so GitHub-linked environments receive it.
-- This is intentionally idempotent: it rewrites only the two public templates below.
SELECT set_config('app.framework_save_in_progress', 'on', true);

-- Modèle Santé Publique France
...
SELECT set_config('app.framework_save_in_progress', 'off', true);