-- Repointe validate_storage_url (les 2 surcharges) vers le host du projet
-- autonome. L'ancien host (aasihxqsasjpszqjlbid) était codé en dur, ce qui
-- rejetait toute URL de logo/photo générée par le nouveau projet → les
-- photos ne se sauvegardaient pas. Regex extension dé-échappée ([.] au lieu de \.).
