...
export function PlayerSidebar({
  ...
  return (
    <aside className="lg:w-[240px] lg:flex-shrink-0 lg:mx-3 lg:mb-3 lg:mt-5 lg:p-0 p-4 lg:h-[calc(100vh-2.5rem)] lg:sticky lg:top-5 lg:overflow-y-auto custom-scrollbar">
