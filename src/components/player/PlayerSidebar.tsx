      ...
      {!isPlayerViewingOwnProfile && canEvaluate && teamMembership && (
        <div className="bg-card border border-border rounded-xl p-3 mb-3">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button variant="outline" size="sm" className="w-full gap-1.5 justify-start text-[11px] h-9 px-2.5 font-semibold text-foreground">
            ...
            <Button variant="outline" size="sm" className="w-full gap-1.5 justify-start text-[11px] h-9 px-2.5 font-semibold text-foreground" onClick={onRequestSupporterEval}>
        ...
        <div className="bg-card border border-border rounded-xl p-3 mb-3">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            {canMutate && teamMembership && (
              <Button variant="outline" size="sm" className="w-full gap-1.5 justify-start text-[11px] h-9 px-2.5 font-semibold text-foreground" onClick={onTransferPlayer}>
