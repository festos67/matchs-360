...
const roleConfig = [
  ...
  { value: "coach", label: "Coach", description: "Évaluer et suivre mes joueurs", icon: UserCog, color: "text-orange-500", border: "border-orange-500", bg: "bg-orange-500/10" },
  { value: "player", label: "Joueur", description: "Consulter mes évaluations", icon: UserCircle, color: "text-green-500", border: "border-green-500", bg: "bg-green-500/10" },
