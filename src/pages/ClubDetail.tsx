...
import { ArrowLeft, Plus, Users, Settings, Edit } from "lucide-react";
  ...
  const fetchClubData = async () => {
    try {
      ...
      const teamsWithCount = (teamsData || []).map((team: any) => ({
        ...team,
        players_count: team.team_members?.filter(
          (m: any) => m.member_type === "player"
        ).length || 0,
      }));
        ...
        <div className="flex items-center gap-8">
          <div
            ...
            style={{
              background: club.logo_url
                ...
                : `linear-gradient(135deg, ${club.primary_color} 0%, ${club.primary_color}88 100%)`,
              color: "white",
              boxShadow: `0 4px 24px -4px ${club.primary_color}40`,
            }}
          >
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mt-2 text-muted-foreground">
              ...
              {club.referent_name && (
                <span>• Référent: {club.referent_name}</span>
              )}
            </div>
          </div>
